  describe('Nested pages', function() {
    describe('About us duplicate page', function () {
      ...
      before( function ( done ) {
        ...
        click(aboutUsLink);
        setTimeout(function(){
        path1 = document.querySelector('spar.aboutus-dup.path1');
          done();
        },500);
      });
    ...
    describe('Home page', function () {
      before(function (done) {
        var homeLink = document.querySelector("spar-link[path='home/dup']");
        click(homeLink);
        setTimeout(function(){
          done();
        },500);
      ...
      it('should display default content and slot content', function() {
        ...
        expect(defaultRoute.innerHTML).to.equal('The below spar is a slot content default');
